package com.radarqr.dating.android.utility.qrgenearator;
...
public class BarcodeEncoder {
    ...
    private BarcodeFormat format = BarcodeFormat.CODE_128;  // Default to CODE_128
    ...
    public static BarcodeFormat convertToZXingFormat(BarcodeFormat aFormat) {
        if (aFormat == null) {
