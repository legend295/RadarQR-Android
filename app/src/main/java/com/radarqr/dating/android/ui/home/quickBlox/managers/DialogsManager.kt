package com.radarqr.dating.android.ui.home.quickBlox.managers
...
import com.radarqr.dating.android.utility.chat.CURRENT_PAGE_BUNDLE_PARAM
import com.radarqr.dating.android.utility.chat.ChatHelper
import com.radarqr.dating.android.utility.chat.TOTAL_PAGES_BUNDLE_PARAM
import com.radarqr.dating.android.utility.chat.USERS_PER_PAGE
...
class DialogsManager {
    ...
    private fun buildMessageCreatedGroupDialog(dialog: QBChatDialog): QBChatMessage {
        ...
        qbChatMessage.body = RaddarApp.getInstance().getString(R.string.new_chat_created, getCurrentUserName(), dialog.name)
    ...
    private fun buildMessageAddedUsers(dialog: QBChatDialog, userIds: String, usersNames: String): QBChatMessage {
        ...
        qbChatMessage.body = RaddarApp.getInstance().getString(R.string.occupant_added, getCurrentUserName(), usersNames)
        qbChatMessage.setSaveToHistory(true)
        qbChatMessage.isMarkable = true
        return qbChatMessage
    }
    ...
    private fun buildMessageLeftUser(dialog: QBChatDialog): QBChatMessage {
        ...
        qbChatMessage.body = RaddarApp.getInstance().getString(R.string.occupant_left, getCurrentUserName())
        qbChatMessage.setSaveToHistory(true)
        qbChatMessage.isMarkable = true
        return qbChatMessage
    }
