...
public class AVLoadingIndicatorViewJava extends View {

    private static final String TAG="AVLoadingIndicatorView";

    private static final BallScaleRippleMultipleIndicator DEFAULT_INDICATOR=new BallScaleRippleMultipleIndicator();
    ...
    public AVLoadingIndicatorViewJava(Context context) {
        super(context);
        init(context, null,0,0);
    }

    public AVLoadingIndicatorViewJava(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0, R.style.AVLoadingIndicatorView);
    }

    public AVLoadingIndicatorViewJava(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr,R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AVLoadingIndicatorViewJava(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
