...
public class TagOnTouchListener implements View.OnTouchListener {
    ...
    public interface OnDragActionListener {
         ...
         * @param view The view dragged
         */
        void onDragEnd(View view, int x, int y);
    }
        ...
        if (isDragging) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    onDragFinish((int)event.getX(), (int)event.getY());
                    break;
    ...
    private void onDragFinish(int x, int y) {
        if (mOnDragActionListener != null) {
            mOnDragActionListener.onDragEnd(mView, x, y);
        }
