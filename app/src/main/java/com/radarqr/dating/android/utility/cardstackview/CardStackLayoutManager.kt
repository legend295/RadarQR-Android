...
import com.radarqr.dating.android.utility.cardstackview.CardStackListener.Companion.default
import com.radarqr.dating.android.utility.cardstackview.internal.CardStackSetting
import com.radarqr.dating.android.utility.cardstackview.internal.CardStackSmoothScroller
import com.radarqr.dating.android.utility.cardstackview.internal.CardStackState
import com.radarqr.dating.android.utility.cardstackview.internal.DisplayUtil

class CardStackLayoutManager(val context: Context, val listener: CardStackListener = default()) :
    ...
    private fun updateOverlay(view: View) {
        ...
        val direction: Direction = state.getDirection()
        val alpha = setting.overlayInterpolator.getInterpolation(state.getRatio())
        when (direction) {
