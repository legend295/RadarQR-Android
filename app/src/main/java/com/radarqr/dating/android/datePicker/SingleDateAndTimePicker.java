...
import static com.radarqr.dating.android.datePicker.SingleDateAndTimeConstants.DAYS_PADDING;
...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    public static final int DELAY_BEFORE_CHECK_PAST = 1;
    ...
    public void setSelectorColor(int selectorColor) {
        dtSelector.setBackgroundResource(R.drawable.rect_white_age);
    }
